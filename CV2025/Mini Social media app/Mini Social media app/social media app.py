...
# Title
title = tk.Label(frame_top, text="NITHYA'S PROFILE", fg="white", bg="#3b5998", font=("Helvetica", 20, "bold"))
title.pack(pady=5)
...
def view_profile():
    ...
    tk.Label(window, text="👤 Nithya's Profile", font=("Arial", 16, "bold"), bg="white").pack(pady=10)
